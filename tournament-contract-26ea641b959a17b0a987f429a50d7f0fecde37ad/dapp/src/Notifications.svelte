...
{#if _add}
  <div
    class:transform={_show}
    class:ease-out={_show}
    class:duration-300={_show}
    class:translate-y-0={_show}
    class:opacity-100={_show}
    class:sm:translate-x-0={_show}
    class:ease-in={!_show}
    class:duration-100={!_show}
    class:opacity-0={!_show}
    class="translate-y-2 sm:translate-y-0 sm:translate-x-2       max-w-sm w-full bg-white shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden transition">
    <div class="p-4">
